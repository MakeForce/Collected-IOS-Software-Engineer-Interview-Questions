...
*	[2)、Objective-C & Xcode]()
	...
	-	[18、下面关于#import和#include的描述正确的是]() <br /> 
...
*	[3)、iOS]()
	...
	-	[25、下面代码的作用是让doSomeThing函数每隔1秒被调用1次，请问哪里有问题]() <br />
    ...
    -	[26、UIViewController在显示过程中，各个方法的调用顺序是]() <br /> 
    ...
    -	[30、什么是key windows？]() <br /> 
    	A . App中唯一的那个UIWindow对象 <br /> B . 可以指定一个key的UIWindow <br /> C . 可以接收到键盘输入等事件的UIWindow <br /> D . 不可以隐藏的那个UIWindow对象 <br /> 
###	[二、简答题]()
*	[1、请写出下列设备的屏幕分辨率：iPhone4/4S,iPhone5/5S,iPhone6,iPhone6 Plus,iPad2,new iPad。]()
*	[2、ViewController的loadView、viewDidLoad、viewDidUnload分别是什么时候调用的，在自定义ViewController时在这几个函数中应该做什么工作？]()
*	[3、简述一下iOS通知中心(NSNotificationCenter)的机制，以及如何使用的？]()
*	[4、请简述一下UITableView的重用机制。]()
*	[5、GCD的Dispatch Queue分为哪三种？他们的区别是什么？]()
###	[三、代码题(C/C++/OC均可)]
*	[请写出一段代码，判断一个整型变量(NSInteger)的二进制表示中有几位取值为1。例如，整型变量n=5，其二进制表示为101，取1的位数共有2个。]()